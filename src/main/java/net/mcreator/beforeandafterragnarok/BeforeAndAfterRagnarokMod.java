 ...
 *
 */
package net.mcreator.beforeandafterragnarok;
...
@Mod("before_and_after_ragnarok")
public class BeforeAndAfterRagnarokMod {
	public static final Logger LOGGER = LogManager.getLogger(BeforeAndAfterRagnarokMod.class);
	public static final String MODID = "before_and_after_ragnarok";
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation(MODID, MODID), () -> PROTOCOL_VERSION,
			PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	private static int messageID = 0;

	public BeforeAndAfterRagnarokMod() {
		BeforeAndAfterRagnarokModTabs.load();
